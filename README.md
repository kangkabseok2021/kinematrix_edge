...
Edge intelligence systems — kinematic trajectory engines, PCB EDA tooling, and embedded control services.

| Project | Description | Docs |
|---|---|---|
| **Kinematrix-Edge: 5-Axis Trajectory Interpolator** | C++ cubic spline (Thomas algorithm) + IK solver, ARM64 benchmarked at 0.25 ms for 9,900 points, FastAPI/Three.js dashboard | [README ↓](#kinematrix-edge-5-axis-trajectory-interpolator) |
| **PCB Component Catalog & Netlist Graph API** | Django 5 + Strawberry GraphQL — JSONB parametric search, `WITH RECURSIVE` BOM explosion, SHA-256 Redis cache, Celery BOM validation, 20 pytest-django tests | [pcb_netlist_graph_api/README.md](pcb_netlist_graph_api/README.md) |
