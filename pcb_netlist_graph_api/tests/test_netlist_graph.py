...
def test_netlist_graph_returns_pins_on_net(execute: Any) -> None:
...
@pytest.mark.django_db
def test_netlist_graph_multiple_components_on_net(execute: Any) -> None:
...
@pytest.mark.django_db
def test_netlist_graph_empty_for_unknown_net(execute: Any) -> None:
...
@pytest.mark.django_db
def test_create_netlist_edge_mutation(execute: Any) -> None:
    comp = ComponentFactory.create()
